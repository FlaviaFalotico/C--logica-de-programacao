...
double numeroUsuario = double.Parse(Console.ReadLine());

if (numeroUsuario < 0.0 || numeroUsuario > 100.0)
{
    Console.WriteLine("Fora de intervalo");
}
else if (numeroUsuario <= 25.0)
{
    Console.WriteLine("Intervalo [0,25]");
}
else if (numeroUsuario <= 50.0)
{
    Console.WriteLine("Intervalo (25,50]");
}
else if (numeroUsuario <= 75.0)
{
